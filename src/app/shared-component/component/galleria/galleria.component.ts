...
export class GalleriaComponent implements AfterViewChecked,AfterViewInit,OnDestroy  {
  @Input() style: any;

  @Input() styleClass: string;

  @Input() panelWidth: number = 900;

  @Input() panelHeight: number = 700;

  @Input() frameWidth: number = 90;
  
  @Input() frameHeight: number = 70;
