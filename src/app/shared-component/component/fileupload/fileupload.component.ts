import {
    Component, OnInit, OnDestroy, Input, Output, EventEmitter, TemplateRef,
    AfterViewInit, AfterContentInit, ContentChildren, QueryList, ViewChild, ElementRef, NgZone
} from '@angular/core';
import { DomSanitizer } from '@angular/platform-browser';
// import { MessagesModule } from '../messages/messages';
// import { ProgressBarModule } from '../progressbar/progressbar';
import { DomHandler, BlockableUI, Message } from './../../common/api';
import { PrimeTemplate } from './../../common/shared.module';
