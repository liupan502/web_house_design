import {
    Component, ElementRef, AfterViewInit, OnDestroy, Input, Output,
    AfterViewChecked, EventEmitter, Renderer2, ContentChild, NgZone
} from '@angular/core';
import { trigger, state, style, transition, animate } from '@angular/animations';
import { CommonModule } from '@angular/common';
import { DomHandler, Confirmation, ConfirmationService } from './../../common/api';
import { Footer } from './../../common/shared.module';
...
export class ConfirmdialogComponent implements AfterViewInit, AfterViewChecked, OnDestroy {
