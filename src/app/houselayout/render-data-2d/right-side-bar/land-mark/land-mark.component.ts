...
export class LandMarkComponent extends PropertyPanel implements OnInit{
  @Input() prevdata: any;
  public objinfo: any;
    ...
    private cdRef: ChangeDetectorRef) {
     super();
      ...
      this.propertyRange_ = [
       ...
       id: PropertyCompares.Property_Between,
       range: [0, 360],
       alarm: '地标旋转角度必须大于0，小于360',
       }), 
    ];
   }

   // 传递范围信息
   allows(index: any): string {
