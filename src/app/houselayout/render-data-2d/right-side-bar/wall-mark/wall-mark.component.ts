import { Component, OnInit,Input ,  ChangeDetectorRef, Directive } from '@angular/core';
import {PropertyComponet, PropertyPanel, PropertyCompares, PropertyRange} from '../property.component';
import {MessageManagerService, DrawHouseLayoutService, WrapperService} from '../../../service/hsservice'
import {DesignService} from '../../../../service/design.service'
import {ForbiddenValidatorDirective} from './wall-mark.directive'
import {AbstractControl, NG_VALIDATORS, Validator, ValidatorFn, Validators} from '@angular/forms'
 
@Component({
  selector: 'hero-form-template',
  templateUrl: './wall-mark.component.html',
  styleUrls: ['./wall-mark.component.css']
})




export class WallMarkComponent extends PropertyPanel implements OnInit {
   @Input() prevdata: any;
   public objinfo: any;
   ...
   constructor(private designService: DesignService, 
    ...
    private cdRef: ChangeDetectorRef, private msgMng: MessageManagerService) {
      super();
       ...
       this.propertyRange_ = [
        ...
        range: [0, 500],
        obj: this.objinfo,  
        alarm: '墙标离地高度必须大于0，小于500',
        }),  

        new PropertyRange({name: 'length_',
        id: PropertyCompares.Property_Between,
        range: [0, 500],
        alarm: '墙标长度必须大于0，小于500',
        }),  
      
        new PropertyRange({name: 'width_',
        id: PropertyCompares.Property_Between,
        range: [0, 500],
        alarm: '墙标宽度必须大于0，小于500',
        }), 

        new PropertyRange({name: 'rotationZ_',
        id: PropertyCompares.Property_Between,
        range: [0, 360],
        alarm: '墙标旋转角度必须大于0，小于360',
        }), 
     ];
    }
