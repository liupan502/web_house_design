...
@Component({
  ...
  templateUrl: './round-land-mark.component.html',
  styleUrls: ['./round-land-mark.component.css']
})

export class RoundLandMarkComponent extends PropertyPanel implements OnInit{
  @Input() prevdata: any;
  public objinfo: any;
