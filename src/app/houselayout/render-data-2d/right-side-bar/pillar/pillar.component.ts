...
export class PillarComponent extends PropertyPanel implements OnInit{
  @Input() prevdata: any;
  public objinfo: any;
    ...
    private cdRef: ChangeDetectorRef) {
     super();
      ...
      this.propertyRange_ = [
       ...
       range: [0, 500],
       obj: this.objinfo,  
       alarm: '组件结构长度必须大于0，小于500',
       }),  
     
       new PropertyRange({name: 'width_',
       id: PropertyCompares.Property_Between,
       range: [0, 500],
       alarm: '组件结构宽度必须大于0，小于500',
       }), 

       new PropertyRange({name: 'height_',
       id: PropertyCompares.Property_Between,
       range: [0, 360],
       alarm: '组件结构高度必须大于0，小于360',
       }), 

       new PropertyRange({name: 'rotationZ_',
       id: PropertyCompares.Property_Between,
       range: [0, 360],
       alarm: '组件结构旋转角度必须大于0，小于360',
       }), 
    ];
   }
