...
@Component({
  ...
  templateUrl: './door-hole.component.html',
  styleUrls: ['./door-hole.component.css']
})


export class DoorHoleComponent extends PropertyPanel implements OnInit{
  @Input() prevdata: any;
  public objinfo: any;
    ...
    private cdRef: ChangeDetectorRef) {
     super();
      ...
      this.propertyRange_ = [
       ...
       range: [0, 500],
       obj: this.objinfo,  
       alarm: '门洞长度必须大于0，小于500',
       }),  
     
       new PropertyRange({name: 'height_',
       id: PropertyCompares.Property_Between,
       range: [0, 500],
       alarm: '门洞高度必须大于0，小于500',
       }), 

       new PropertyRange({name: 'width_',
       id: PropertyCompares.Property_Between,
       range: [0, 360],
       alarm: '门洞厚度必须大于0，小于500',
       }), 

       new PropertyRange({name: 'archeight_',
       id: PropertyCompares.Property_Between,
       range: [0, 360],
       alarm: '门洞拱高必须大于0，小于500',
       }), 
    ];
   }
