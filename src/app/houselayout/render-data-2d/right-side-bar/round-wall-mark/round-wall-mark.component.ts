...
@Component({
  ...
  templateUrl: './round-wall-mark.component.html',
  styleUrls: ['./round-wall-mark.component.css']
})

export class RoundWallMarkComponent extends PropertyPanel implements OnInit{
  @Input() prevdata: any;
  public objinfo: any;
  ...
  constructor(private designService: DesignService, 
    ...
    private cdRef: ChangeDetectorRef) {
     super();
      ...
      this.propertyRange_ = [
       ...
       range: [0, 500],
       obj: this.objinfo,  
       alarm: '地标离地高度必须大于0，小于500',
       }),  
     
       new PropertyRange({name: 'radius_',
       id: PropertyCompares.Property_Between,
       range: [0, 500],
       alarm: '地标直径必须大于0，小于500',
       }), 
    ];
   }
   ...
   hoopup() {
     ...
     this.objinfo.radius_ = this.getProperty('radius_');
   }
   ...
   injectval() {
     ...
     this.data.radius_ = parseFloat(this.objinfo.radius_);
     return;
   }
   ...
   protected doModify(): boolean {
     ...
     if (this.data.radius_ !== this.prevdata.radius_) {
       return true;
     }
